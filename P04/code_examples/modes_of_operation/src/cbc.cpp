/*
 * Example of CBC mode of operation using AES
 */
...
int main(void) {
    ...
    // Input message
    std::string input = "Hello world!, this is a very long message to test CBC mode with AES provided by the Crypto++ library!";
